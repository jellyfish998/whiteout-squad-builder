...
const AdjustedRatioDisplay = ({ totalTroops, desiredRatio, marchSizes, isRallyCaller, remainingTroops}) => {
  const calculateAdjustedRatios = () => {

    if (!marchSizes || marchSizes.length === 0) {
        return { adjRatio: {}, error: "March sizes are required." };
    }
